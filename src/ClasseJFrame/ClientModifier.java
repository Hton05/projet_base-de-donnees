...
public class ClientModifier extends JFrame {
	...
	public ClientModifier(String id, String nom1, String prenom1, String tel1, String adresse1, String email1) {
		...
		btnEnregistrer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (nom.getText().equals("") || prenom.getText().equals("") || tel.getText().equals("") || adresse.getText().equals("") || email.getText().equals("")) {
					...
					String [] contenu = {n1, p1, tel.getText(), adresse.getText(), email.getText()};					
					db.update("client", nomColonne, contenu, "idClient = '" +id+ "'");
					setVisible(false);
				}
			}
		});
